 ...
 * zee Routes
 */
Route::any('{all}','AngularController@serveFrontend');
Route::get('/', 'AngularController@serveFrontend');
/*
 * =====================================================
 */
//ROUTE
...
//SITE SETTINGS
Route::get('settingsshow/{id}', 'SettingsController@showsettings');
Route::post('settingsedit/{id}', 'SettingsController@editsettings');
...
Route::any('compareByName', 'FrontEndController@compareByName');
/*Route::any('category/{id}/{price}', 'FrontEndController@category');
Route::any('category/{id}/{from_price}/{to_price}', 'FrontEndController@category');
Route::any('category/{id}/{price}/{attribute}', 'FrontEndController@category');
Route::any('category/{id}/{attribute}', 'FrontEndController@category');*/
Route::any('category/{id}/{price}', 'FrontEndController@category');
Route::any('category/{id}/{fromto}', 'FrontEndController@category');
Route::any('category/{id}/{attribute}', 'FrontEndController@category');
Route::any('category/{id}/{price}/{attribute}', 'FrontEndController@category');
Route::any('category/{id}/{price}/{attribute}/{fromto}', 'FrontEndController@category');
Route::any('category/{id}/{price}/{attribute}/{fromto}/{sort}', 'FrontEndController@category');
...
Route::any('/checkoutpage', 'CheckOutController@index');
Route::any('checkoutpage/{id}', 'CheckOutController@index');
Route::prefix('cart', function(){
	Route::get('checkout', 'CartController@index');
});
Route::any('cart/ajaxpayment', 'CheckOutController@checkoutAjax');
Route::post('addaddress', 'CheckOutController@add');
Route::any('cart/check_card', 'CheckOutController@check_card');
Route::any('cart/add_creditcard', 'CheckOutController@add_creditcard');
Route::any('cart/get_card', 'CheckOutController@get_card');
Route::any('cart/edit_creditcard', 'CheckOutController@edit_creditcard');
Route::any('cart/add_bank', 'CheckOutController@add_bank');
Route::any('cart/review', 'CheckOutController@review');
Route::any('cart/review2', 'CheckOutController@review2');
Route::any('cart/checkoutCustomer', 'CheckOutController@checkoutCustomer');
Route::any('thanks/index', 'ThanksController@index');

//SEND EMAIL
Route::any('sendEmail/{str}/{user_email}/{profile}', 'PhpmailerController@sendEmail');
...
Route::any('attachment_email/{str}/{user_email}/{profile}','MailController@attachment_email');
