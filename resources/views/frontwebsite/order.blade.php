          ...
          <div class="mycart">
                ...
                <table id="tbl_mycart">
                    ...
                    <tr>
						...
						?></td>
                        <td>
                        	<a href="{{ url('order/detail') }}<?php echo '/'.$post['order_id'];?>">
								<img src="{{ url('/uploads/view_order.png') }}" border="0" title="Order Detail" />
                            </a>
                        </td>
                        <td><a href="{{ url('order/reorder') }}<?php echo '/'.$post['order_id']; ?>" style="color:#428bca !important">Re-Order</a></td>
                    </tr>
