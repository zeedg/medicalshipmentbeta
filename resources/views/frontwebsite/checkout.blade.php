          ...
          <div class="col-lg-12 pad-left">
			...
			?>
                    <tr class="first odd">
                      ...
                      <td><a href="<?php echo 'index.php?controller=product&function=index&id='.$product_id?>"> <img src="{{ url('/uploads/product/' . trim($mfa[0]->product_image)) }}" alt="<?php echo stripslashes($mfa[0]->product_title)?>" class="img-responsive" width="100px"; > </a></td>
                      <td><a href="<?php echo 'index.php?controller=product&function=index&id='.$product_id?>"><?php echo stripslashes($mfa[0]->product_title)?></a>
                        </td>
                      <td>
                      
                <a onclick="document.getElementById('form_whish_<?php echo intval($product_id)?>').submit();">Move</a></td>
                      <td><?php
                    ...
                    <tbody>
                      ...
                      <!--<tr class="cartbotborder">
                        ...
                        <td style="" class="a-right" id="sveUkupno_sub"><span class="price" id="gtotal">$8.75</span></td>
                                    ...
                                    <form action="https://www.medicalshipment.com/index.php?controller=cart&function=payment" method="post" id="form_pm" name="form_pm">
                    <div class="clear"></div>
                    <div class="subtotal">
                    ...
                    <ul class="checkout-types">
                      <li style="text-align:center;">
                        <div id="button_change">
                          <a href="{{ url('cart/checkoutpage') }}" class="button2 btn-proceed-checkout btn-checkout2 btncart add_cart" title="">
                           <span style="display: inline-table;"><span style="margin-right:0px !important;color:#FFF">Proceed to Checkout</span></span></a>
                        </div>
                      </li>
                      <li style="text-align:center;">
