...
<section class="content">
  ...
  <form class="form" action="{{ url('/superadminedit') }}/{{ $user->id }}" id="registerformadmin" method='post'>
  <!-- NEW PROFILE -->
  <div class="row">
        <div class="col-md-3">
                    ...
                    <div class="form-horizontal">
                      <div class="box-body">
                          ...
                          <div class="col-md-6 col-xs-12">
                              ...
                              <input  class='form-control' type='hidden' name='old_password' id='old_password' value='{{ $user->password }}' />
                          </div>
                    ...
                    <div class="box box-info">
                      ...
                      <div class="form-horizontal">
                        <div class="box-body">
                          ...
                          <input class='btn btn-primary' name="update_adminuser" type='submit' value='Update' class='submit' />
                          <a class='btn btn-warning' href="{{ url('/superadminshow') }}/{{ $user->id }}">Reset</a><br><br>
