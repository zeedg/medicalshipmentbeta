...
<section class="content">
  ...
  <form class="form" action="{{ url('/unitedit') }}/{{ $unit->unit_id }}" id="categoryform" method='post'>
  <!-- NEW PROFILE -->
  <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">Update Unit</h3>
                    ...
                    <div class="form-horizontal">
                      <div class="box-body">
                          ...
                          <div class="col-md-6 col-xs-12">
                            <label>Title:</label>
                            <input  class='form-control' type='text' name='title' id='title' value='{{ $unit->unit_title }}' />
                          </div>
                    ...
                    <div class="box box-info">
                      ...
                      <div class="form-horizontal">
                        <div class="box-body">
                          ...
                          <input class='btn btn-primary' name="update_unit" type='submit' value='Update' class='submit' />
                          <a class='btn btn-warning' href="{{ url('/unitupdate') }}/{{ $unit->unit_id }}">Reset</a><br><br>
