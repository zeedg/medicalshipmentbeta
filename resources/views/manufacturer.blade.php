            ...
            <div class="col-md-6">
              <input placeholder="Search..." type="text" name="search_value" onkeyup="getuser_record(this.value)" class="form-control" value="{{ Session::get('keyword') }}" id="keyWord">
				...
				<?php $mi = 0; ?>
					...
					<?php $mi++; ?>
										<tr id="user" class="">
											<td>{{ $manufacturer->manu_id }}</td>
											<td>
												{{ $manufacturer->manu_title }}
											</td>
											...
											<td>
												<div class="dropdown">
													...
													<ul class="dropdown-menu" style="right: 0; left: auto;" aria-labelledby="dropdownMenu">
														<li class="">
															<a href="manufacturerupdate/{{ $manufacturer->manu_id }}" class="tip" data-placement="left" data-element="user38" title="View/Edit $manufacturer->manu_title"><i class="fa fa-pencil text text-primary"></i> View/Edit {{ $manufacturer->manu_title }}</a>
														</li>
														
														<li role="separator" class="divider"></li>
														
														<li class="">
															<a href="destroymanufacturer/{{ $manufacturer->manu_id }}" class="dAction tip" data-id="{{ $manufacturer->manu_id }}" data-option="" data-type="deactivate-user" data-modal-title="De/Activate Thandi Ngobese's Account" data-modal-text="Are you sure you want to De/Activate this User Account ?" data-form="adminUsers" data-placement="left" data-element="user$manufacturer->manu_id" title="De/Activate $manufacturer->manu_title"><i class="fa fa-ban text text-danger"></i> De/Activate {{ $manufacturer->manu_title }}
															</a>
														</li>
