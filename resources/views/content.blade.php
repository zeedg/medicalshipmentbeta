											...
											<td>
												<div class="dropdown">
													...
													<ul class="dropdown-menu" style="right: 0; left: auto;" aria-labelledby="dropdownMenu">
														<li class="">
															<a href="contentupdate/{{ $page->page_id }}" class="tip" data-placement="left" data-element="user38" title="View/Edit {{ $page->page_title }}"><i class="fa fa-pencil text text-primary"></i> View/Edit {{ $page->page_title }}</a>
														</li>
														
														<li role="separator" class="divider"></li>
														
														<li class="">
															<a href="destroycontent/{{ $page->page_id }}" class="dAction tip" data-id="{{ $page->page_id }}" data-option="" data-type="deactivate-user" data-modal-title="De/Activate Thandi Ngobese's Account" data-modal-text="Are you sure you want to De/Activate this content ?" data-form="adminUsers" data-placement="left" data-element="user{{ $page->page_id }}" title="De/Activate {{ $page->page_title }}"><i class="fa fa-ban text text-danger"></i> De/Activate {{ $page->page_title }}</a>
														</li>
