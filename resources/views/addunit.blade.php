...
<section class="content">
  ...
  <form class="form" action="{{ url('/storeunit') }}" id="categoryform" method='post'>
  <!-- NEW PROFILE -->
  <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">Add New Unit</h3>
                    ...
                    <div class="box box-info">
                      ...
                      <div class="form-horizontal">
                        <div class="box-body">
                          ...
                          <input class='btn btn-primary' name="add_unit" type='submit' value='Submit' class='submit' />
                          <a class='btn btn-warning' href="{{ url('/addunit') }}">Reset</a><br><br>
