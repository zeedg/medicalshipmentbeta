	        	...
	        	<div class="allutable"><!--  table-responsive -->
					<table class='table table-bordered table-striped table-list-search dataTable'>
						...
						<tr>
					 	...
					 	<tbody>
<?php
foreach ($keywords_arr as $post){ 
?>
<tr id="user" class="">
	<td><?php echo trim(stripslashes($post->keyword))?></td>
	<td><?php echo trim(stripslashes($post->categories_value))?></td>
	...
	<td>
		<div class="dropdown">
			...
			<ul class="dropdown-menu"  style="right: 0; left: auto;"  aria-labelledby="dropdownMenu">
				<li class="">
					<a href="keywordupdate/<?php echo $post->id?>" class="tip" data-placement="left" data-element="user38" title="View/Edit <?php echo $post->keyword ?>"><i class="fa fa-pencil text text-primary"></i> View/Edit <?php echo $post->keyword ?></a>
				</li>

				<li role="separator" class="divider"></li>

				<li class="">
					<a href="destroykeyword/<?php echo $post->id?>" class="dAction tip" data-id="<?php echo $post->id?>" data-option="" data-type="deactivate-user" data-modal-title="De/Activate Thandi Ngobese's Account" data-modal-text="Are you sure you want to De/Activate this User Account ?" data-form="adminUsers"  data-placement="left" data-element="user <?php echo $post->id ?>" title="De/Activate <?php echo $post->keyword ?>" ><i class="fa fa-ban text text-danger"></i> De/Activate <?php echo $post->keyword ?></a>
				</li>
