...
$base_url = "http://localhost/laravel/laravel/jscss/";
//$base_url = "http://medicalshipmentbeta.com/manager/jscss/";
?> 
...
<meta property="og:image" content="https://help.prospectz.io/wp-content/uploads/2018/12/prospectzio-app.jpg"/>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?php echo $base_url; ?>app-uploads/app-setting-uploads/mdimg.png">
  <link rel="shortcut icon" sizes="96x96" href="<?php echo $base_url; ?>app-uploads/app-setting-uploads/mdimg.png">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <br/>
      ...
      <img src="<?php echo $base_url; ?>app-uploads/app-setting-uploads/mdimg.png" class="" alt="Logo" style='width:153px;' />
      
      <br/>
      
      @if(isset(Auth::user()->email))
      	<script>window.location="/manager/main/successlogin";</script>
      @endif
