...
<section class="content">
  ...
  <form class="form" action="{{ url('/storefacility') }}" enctype="multipart/form-data" id="facilityform" method='post'>
  <!-- NEW PROFILE -->
  <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">Add New Facility</h3>
                    ...
                    <div class="box box-info">
                      ...
                      <div class="form-horizontal">
                        <div class="box-body">
                          ...
                          <input class='btn btn-primary' name="add_facility" type='submit' value='Submit' class='submit' />
                          <a class='btn btn-warning' href="{{ url('/addfacility') }}">Reset</a><br><br>
