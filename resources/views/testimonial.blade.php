	...
	<td>
		<div class="dropdown">
			...
			<ul class="dropdown-menu"  style="right: 0; left: auto;"  aria-labelledby="dropdownMenu">
				<li class="">
					<a href="testimonialupdate/{{ $testimonial->testimonial_id }}" class="tip" data-placement="left" data-element="user38" title="View/Edit {{ $testimonial->testimonial_name }}"><i class="fa fa-pencil text text-primary"></i> View/Edit {{ $testimonial->testimonial_name }}</a>
				</li>

				<li role="separator" class="divider"></li>

				<li class="">
					<a href="destroytestimonial/{{ $testimonial->testimonial_id }}" class="dAction tip" data-id="{{ $testimonial->testimonial_id }}" data-option="" data-type="deactivate-user" data-modal-title="De/Activate Thandi Ngobese's Account" data-modal-text="Are you sure you want to De/Activate this User Account ?" data-form="adminUsers"  data-placement="left" data-element="user{{ $testimonial->testimonial_id }}" title="De/Activate {{ $testimonial->testimonial_name }}" ><i class="fa fa-ban text text-danger"></i> De/Activate {{ $testimonial->testimonial_name }}</a>
				</li>
