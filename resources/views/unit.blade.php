	...
	<td style="text-align:right;">
		<div class="dropdown">
			...
			<ul class="dropdown-menu"  style="right: 0; left: auto;"  aria-labelledby="dropdownMenu">
				<li class="">
					<a href="unitupdate/{{ $unit->unit_id }}" class="tip" data-placement="left" data-element="user38" title="View/Edit $unit->unit_title"><i class="fa fa-pencil text text-primary"></i> View/Edit {{ $unit->unit_title }}</a>
				</li>

				<li role="separator" class="divider"></li>

				<li class="">
					<a href="destroyunit/{{ $unit->unit_id }}" class="dAction tip" data-id="{{ $unit->unit_id }}" data-option="" data-type="deactivate-user" data-modal-title="De/Activate Thandi Ngobese's Account" data-modal-text="Are you sure you want to De/Activate this User Account ?" data-form="adminUsers"  data-placement="left" data-element="user$unit->unit_id" title="De/Activate $unit->unit_title" ><i class="fa fa-ban text text-danger"></i> De/Activate {{ $unit->unit_title }}</a>
				</li>
