...
<tr id="user" class="">
    ...
    <td>
        ...
        <img src="<?php echo url('/uploads/facility/'.$facility->facility_image) ?>" onerror="this.src='<?php echo url('/uploads/default.jpg') ?>'" class="img-circle" alt="Facility Image" width="100px">
    	<?php } else { ?>
        <img src="<?php echo url('/uploads/default.jpg') ?>" onerror="this.src='<?php echo url('/uploads/default.jpg') ?>'" class="img-circle" alt="Facility Image" width="100px">
        <?php } ?>
    </td>
	...
	<td>
		<div class="dropdown">
			...
			<ul class="dropdown-menu"  style="right: 0; left: auto;"  aria-labelledby="dropdownMenu">
				<li class="">
					<a href="facilityupdate/{{ $facility->facility_id }}" class="tip" data-placement="left" data-element="user38" title="View/Edit {{ $facility->facility_title }}"><i class="fa fa-pencil text text-primary"></i> View/Edit {{ $facility->facility_title }}</a>
				</li>

				<li role="separator" class="divider"></li>

				<li class="">
					<a href="destroyfacility/{{ $facility->facility_id }}" class="dAction tip" data-id="{{ $facility->facility_id }}" data-option="" data-type="deactivate-user" data-modal-title="De/Activate Thandi Ngobese's Account" onclick="return confirm('Are you sure you want to delete this record?');" data-modal-text="Are you sure you want to De/Activate this User Account ?" data-form="adminUsers"  data-placement="left" data-element="user{{ $facility->facility_id }}" title="De/Activate {{ $facility->facility_title }}" ><i class="fa fa-ban text text-danger"></i> De/Activate {{ $facility->facility_title }}</a>
				</li>
